...
function ChecklistRow({
  ...
  <div className="tc-row" style={{ justifyContent: "space-between", gap: 10, flexWrap: "wrap" }}>
    <div>
      <div className="tc-title">🗂️ Ficha cliente</div>
      <div className="tc-sub" style={{ marginTop: 6 }}>
        Ver y editar cliente seleccionado
      </div>
    </div>
  ...
  {!crmClienteSelId ? (
    <div className="tc-sub">Selecciona un cliente en “Ver ficha”.</div>
  ) : crmFichaLoading ? (
    <div className="tc-sub">Cargando ficha…</div>
  ) : !crmClienteFicha ? (
    <div className="tc-sub">{crmFichaMsg || "No se pudo cargar la ficha."}</div>
  ) : (
    <>
      <div className="tc-grid-4">
        <div>
